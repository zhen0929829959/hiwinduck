...
inline void to_flow_style_yaml(
  const CalibConfigWrite_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: calib_config
...
inline std::string to_yaml(const CalibConfigWrite_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const realsense2_camera_msgs::srv::CalibConfigWrite_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const realsense2_camera_msgs::srv::CalibConfigWrite_Request & msg)
{
...
inline void to_flow_style_yaml(
  const CalibConfigWrite_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const CalibConfigWrite_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use realsense2_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const realsense2_camera_msgs::srv::CalibConfigWrite_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  realsense2_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use realsense2_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const realsense2_camera_msgs::srv::CalibConfigWrite_Response & msg)
{
  return realsense2_camera_msgs::srv::to_yaml(msg);
}
