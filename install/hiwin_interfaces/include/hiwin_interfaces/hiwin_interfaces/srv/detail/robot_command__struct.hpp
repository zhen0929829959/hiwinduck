...
struct RobotCommand_Request_
{
  ...
  using _move_dir_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  _move_dir_type move_dir;
  using _move_dis_type =
    double;
  _move_dis_type move_dis;
  ...
  static constexpr uint8_t MOTION_STOP =
    15u;
  static constexpr uint8_t FLANGE_MOVE =
    16u;
  ...
  bool operator==(const RobotCommand_Request_ & other) const
  {
    ...
    if (this->move_dir != other.move_dir) {
      return false;
    }
    if (this->move_dis != other.move_dis) {
      return false;
    }
    return true;
  }
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t RobotCommand_Request_<ContainerAllocator>::FLANGE_MOVE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
