...
static rosidl_typesupport_introspection_c__MessageMember hiwin_interfaces__srv__RobotCommand_Request__rosidl_typesupport_introspection_c__RobotCommand_Request_message_member_array[21] = {
  {
    "do_timer",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hiwin_interfaces__srv__RobotCommand_Request, move_dir),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hiwin_interfaces__srv__RobotCommand_Request, move_dis),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
