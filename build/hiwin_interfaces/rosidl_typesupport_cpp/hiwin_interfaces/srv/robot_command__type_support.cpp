...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, hiwin_interfaces, srv, RobotCommand)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<hiwin_interfaces::srv::RobotCommand>();
}
