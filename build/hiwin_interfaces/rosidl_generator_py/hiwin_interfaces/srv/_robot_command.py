...
class Metaclass_RobotCommand_Request(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'FLANGE_MOVE': cls.__constants['FLANGE_MOVE'],
    ...
    @property
    def FLANGE_MOVE(self):
        """Message constant 'FLANGE_MOVE'."""
        return Metaclass_RobotCommand_Request.__constants['FLANGE_MOVE']
...
class RobotCommand_Request(metaclass=Metaclass_RobotCommand_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.move_dir = kwargs.get('move_dir', str())
        self.move_dis = kwargs.get('move_dis', float())
    ...
    def __eq__(self, other):
        ...
        if self.jog_dir != other.jog_dir:
            return False
        if self.move_dir != other.move_dir:
            return False
        if self.move_dis != other.move_dis:
            return False
        return True
    ...
    def move_dir(self, value):
        if __debug__:
            assert \
                ...
                "The 'move_dir' field must be of type 'str'"
        self._move_dir = value

    @builtins.property
    def move_dis(self):
        """Message field 'move_dis'."""
        return self._move_dis

    @move_dis.setter
    def move_dis(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'move_dis' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'move_dis' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._move_dis = value
