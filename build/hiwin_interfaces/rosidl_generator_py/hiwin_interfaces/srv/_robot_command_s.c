...
bool hiwin_interfaces__srv__robot_command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // move_dir
    PyObject * field = PyObject_GetAttrString(_pymsg, "move_dir");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->move_dir, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // move_dis
    PyObject * field = PyObject_GetAttrString(_pymsg, "move_dis");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->move_dis = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * hiwin_interfaces__srv__robot_command__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // move_dir
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->move_dir.data,
      strlen(ros_message->move_dir.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "move_dir", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // move_dis
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->move_dis);
    {
      int rc = PyObject_SetAttrString(_pymessage, "move_dis", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
