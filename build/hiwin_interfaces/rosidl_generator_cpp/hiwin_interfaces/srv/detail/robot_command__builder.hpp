...
class Init_RobotCommand_Request_move_dis
{
public:
  explicit Init_RobotCommand_Request_move_dis(::hiwin_interfaces::srv::RobotCommand_Request & msg)
  : msg_(msg)
  {}
  ::hiwin_interfaces::srv::RobotCommand_Request move_dis(::hiwin_interfaces::srv::RobotCommand_Request::_move_dis_type arg)
  {
    msg_.move_dis = std::move(arg);
...
class Init_RobotCommand_Request_move_dir
{
public:
  explicit Init_RobotCommand_Request_move_dir(::hiwin_interfaces::srv::RobotCommand_Request & msg)
  : msg_(msg)
  {}
  Init_RobotCommand_Request_move_dis move_dir(::hiwin_interfaces::srv::RobotCommand_Request::_move_dir_type arg)
  {
    msg_.move_dir = std::move(arg);
    return Init_RobotCommand_Request_move_dis(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_RobotCommand_Request_move_dir jog_dir(::hiwin_interfaces::srv::RobotCommand_Request::_jog_dir_type arg)
  {
    msg_.jog_dir = std::move(arg);
    return Init_RobotCommand_Request_move_dir(msg_);
  }
