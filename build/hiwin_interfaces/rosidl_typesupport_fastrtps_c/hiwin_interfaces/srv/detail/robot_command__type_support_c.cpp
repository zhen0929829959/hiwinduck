...
#include "rosidl_runtime_c/string.h"  // move_dir
#include "rosidl_runtime_c/string_functions.h"  // move_dir
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: move_dir
  {
    const rosidl_runtime_c__String * str = &ros_message->move_dir;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: move_dir
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->move_dir.data) {
      rosidl_runtime_c__String__init(&ros_message->move_dir);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->move_dir,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'move_dir'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->move_dir.size + 1);
  // field.name move_dis
  {
    size_t item_size = sizeof(ros_message->move_dis);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
