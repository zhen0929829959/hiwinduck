...
#define NODE_MAIN_LOGGER_NAME "realsense2_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librealsense2_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<realsense2_camera::RealSenseNodeFactory>";
