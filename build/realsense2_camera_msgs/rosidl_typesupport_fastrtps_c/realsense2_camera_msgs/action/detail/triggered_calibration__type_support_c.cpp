  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_Goal__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: json
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_Result__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_Feedback__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: progress
  {
    cdr >> ros_message->progress;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, action, TriggeredCalibration_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_SendGoal_Request__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_SendGoal_Response__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_GetResult_Request__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, action, TriggeredCalibration_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_GetResult_Response__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, action, TriggeredCalibration_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _TriggeredCalibration_FeedbackMessage__ros_msg_type * ros_message = static_cast<_TriggeredCalibration_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
