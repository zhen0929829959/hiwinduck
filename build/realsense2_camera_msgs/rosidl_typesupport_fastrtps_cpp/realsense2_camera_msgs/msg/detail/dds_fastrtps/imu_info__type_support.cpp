...
#include "realsense2_camera_msgs/msg/detail/imu_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = realsense2_camera_msgs::msg::IMUInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const realsense2_camera_msgs::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<realsense2_camera_msgs::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  return &realsense2_camera_msgs::msg::typesupport_fastrtps_cpp::_IMUInfo__handle;
}
