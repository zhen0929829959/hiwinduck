...
static const _SafetyPresetWrite_Request_type_support_symbol_names_t _SafetyPresetWrite_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Request)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetWrite_Request_message_type_support_handle;
}
...
static const _SafetyPresetWrite_Response_type_support_symbol_names_t _SafetyPresetWrite_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Response)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetWrite_Response_message_type_support_handle;
}
...
static const _SafetyPresetWrite_type_support_symbol_names_t _SafetyPresetWrite_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetWrite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetWrite)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetWrite)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetWrite_service_type_support_handle;
}
