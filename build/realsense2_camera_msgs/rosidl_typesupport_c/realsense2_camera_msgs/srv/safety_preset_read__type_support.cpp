...
static const _SafetyPresetRead_Request_type_support_symbol_names_t _SafetyPresetRead_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetRead_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetRead_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetRead_Request)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetRead_Request_message_type_support_handle;
}
...
static const _SafetyPresetRead_Response_type_support_symbol_names_t _SafetyPresetRead_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetRead_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetRead_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetRead_Response)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetRead_Response_message_type_support_handle;
}
...
static const _SafetyPresetRead_type_support_symbol_names_t _SafetyPresetRead_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetRead)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetRead)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetRead)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetRead_service_type_support_handle;
}
