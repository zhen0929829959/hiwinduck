...
static const _CalibConfigRead_Request_type_support_symbol_names_t _CalibConfigRead_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, CalibConfigRead_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigRead_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, CalibConfigRead_Request)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::CalibConfigRead_Request_message_type_support_handle;
}
...
static const _CalibConfigRead_Response_type_support_symbol_names_t _CalibConfigRead_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, CalibConfigRead_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigRead_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, CalibConfigRead_Response)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::CalibConfigRead_Response_message_type_support_handle;
}
...
static const _CalibConfigRead_type_support_symbol_names_t _CalibConfigRead_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, CalibConfigRead)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigRead)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, CalibConfigRead)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::CalibConfigRead_service_type_support_handle;
}
