...
bool realsense2_camera_msgs__srv__hardware_monitor_command_send__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("realsense2_camera_msgs.srv._hardware_monitor_command_send.HardwareMonitorCommandSend_Request", full_classname_dest, 92) == 0);
  }
  realsense2_camera_msgs__srv__HardwareMonitorCommandSend_Request * ros_message = _ros_message;
  {  // opcode
    ...
    ros_message->opcode = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // param1
    ...
    assert(PyLong_Check(field));
    ros_message->param1 = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // param2
    ...
    assert(PyLong_Check(field));
    ros_message->param2 = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // param3
    ...
    assert(PyLong_Check(field));
    ros_message->param3 = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // param4
    ...
    assert(PyLong_Check(field));
    ros_message->param4 = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of HardwareMonitorCommandSend_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("realsense2_camera_msgs.srv._hardware_monitor_command_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HardwareMonitorCommandSend_Request");
  ...
  {  // param1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->param1);
    {
  ...
  {  // param2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->param2);
    {
  ...
  {  // param3
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->param3);
    {
  ...
  {  // param4
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->param4);
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool realsense2_camera_msgs__srv__hardware_monitor_command_send__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("realsense2_camera_msgs.srv._hardware_monitor_command_send.HardwareMonitorCommandSend_Response", full_classname_dest, 93) == 0);
  }
  realsense2_camera_msgs__srv__HardwareMonitorCommandSend_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // result
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->result.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of HardwareMonitorCommandSend_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("realsense2_camera_msgs.srv._hardware_monitor_command_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HardwareMonitorCommandSend_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // result
    ...
    if (ros_message->result.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->result.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->result.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
