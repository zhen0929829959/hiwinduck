...
class YoloNode(Node):
    def __init__(self):
        ...
        # self.fx = 1370.481966698142
        # self.fy = 1368.2282506378035
        # self.cx = 957.8839678123309
        # self.cy = 541.0615417682238
        ...
        self.declare_parameter('apriltag_pose_topic', '/apriltag/pose_camera')
        ...
        self.declare_parameter('yolo_plane_offset_m', -0.115)
        self.declare_parameter('model_path', 'src/yolo/best.pt')

        self.camera_id = self.get_parameter('camera_id').value
        self.image_topic = self.get_parameter('image_topic').value
        self.apriltag_pose_topic = self.get_parameter('apriltag_pose_topic').value
        ...
        self.yolo_plane_offset_m = float(
            self.get_parameter('yolo_plane_offset_m').value
        )
